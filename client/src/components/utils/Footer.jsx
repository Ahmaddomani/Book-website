export const Footer = () => {
  return (
    <footer className={`w-full dark:darkClass`}>
      <div className="  px-4 sm:px-6 lg:px-8 border-t">
        {/* <!--Grid--> */}
        <div className="grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] gap-3 md:gap-8 py-10 max-sm:max-w-sm max-sm:mx-auto gap-y-8">
          <div className=" ">
        ...
        <div className="py-7 border-t border-gray-200">
          <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
            <span className="text-sm text-gray-500 ">
              ©<a href="https://pagedone.io/">Book</a> 2025, All rights
              reserved.
            </span>
